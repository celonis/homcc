...
class TestSummaryStats:
    ...
    def test_time_measures(self):
        ...
        with pytest.raises(ValueError, match=r"Timestamp of compilation start cannot be after timestamp of compilation "
                                             r"end!"):
        ...
        with pytest.raises(ValueError, match=r"Timestamp of preprocessing start cannot be after timestamp of "
                                             r"preprocessing end!"):
